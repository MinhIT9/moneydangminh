...
export const metadata: Metadata = {
  ...
  title: 'Minh Finance | Ghi thu chi đơn giản mỗi ngày',
  description:
    'Minh Finance giúp học sinh, sinh viên, gia đình trẻ và người làm tự do ghi thu chi nhanh, rõ ràng và dễ duy trì mỗi ngày.',
  keywords: [
    'quản lý chi tiêu',
    'ghi thu chi',
    'sổ thu chi cá nhân',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Minh Finance - Ghi thu chi đơn giản mỗi ngày',
      },
    ],
  },
  twitter: {
...
const faqs = [
  {
    question: 'Minh Finance phù hợp với ai?',
    answer:
  ...
  '@graph': [
    {
      ...
      url: siteUrl,
      description:
        'Ứng dụng ghi thu chi cá nhân đơn giản cho học sinh, sinh viên, gia đình trẻ và người làm tự do.',
      offers: {
        '@type': 'Offer',
        price: '0',
        priceCurrency: 'VND',
  ...
  return (
    <main className="landing">
      ...
      <header className="landing__header">
        <Link className="landing__brand" href="/" aria-label="Trang chủ Minh Finance">
          <span className="landing__brand-mark" aria-hidden="true">
            M
          </span>
          <span>Minh Finance</span>
        </Link>

        <nav className="landing__nav" aria-label="Điều hướng chính">
      ...
      <section className="landing__hero" aria-labelledby="hero-title">
        <div className="landing__hero-copy">
          <p className="landing__eyebrow">Sổ thu chi nhẹ nhàng cho mỗi ngày</p>
          <h1 id="hero-title">Tiền đi đâu, bạn biết rõ.</h1>
          <p className="landing__lead">
            Ghi một khoản thu hoặc chi trong vài giây. Minh Finance giúp bạn nhìn lại tháng của mình
            rõ ràng hơn, không cần bảng tính phức tạp.
          </p>
          <div className="landing__hero-actions">
            <Link className="landing__button" href="/register">
              Tạo sổ thu chi của tôi
          ...
          <p className="landing__note">Dễ dùng trên điện thoại, máy tính bảng và máy tính.</p>
        </div>

        <div className="landing__preview" aria-label="Minh họa màn hình tổng quan thu chi">
          <div className="landing__preview-top">
            <div>
              <span className="landing__muted">Tháng này</span>
              <strong>Tháng 8 năm 2026</strong>
            </div>
            <span className="landing__avatar">M</span>
          </div>
          <div className="landing__balance-card">
            <span>Số tiền còn lại</span>
            <strong>2.450.000 đ</strong>
            <small>+ 320.000 đ so với tuần trước</small>
          </div>
      ...
      <section className="landing__section" id="tinh-nang" aria-labelledby="features-title">
        <div className="landing__section-heading">
          <p className="landing__eyebrow">Đủ đơn giản để dùng mỗi ngày</p>
          <h2 id="features-title">Không cần giỏi tài chính mới quản lý được tiền.</h2>
          <p>
            Bắt đầu từ những điều gần gũi nhất: một cuốc xe, ly nước, tiền chợ hay khoản lương vừa
            nhận.
          </p>
        </div>
        <div className="landing__feature-grid">
          <article className="landing__feature-card">
            ...
            <h3>Ghi nhanh, không rườm rà</h3>
            <p>Chọn Thu hoặc Chi, nhập số tiền và danh mục. Vậy là xong một lần ghi chép.</p>
          </article>
          <article className="landing__feature-card">
            <span className="landing__feature-icon" aria-hidden="true">
              ↗
            </span>
            <h3>Nhìn tổng quan theo tháng</h3>
            <p>Biết tiền đã vào bao nhiêu, đã chi cho việc gì và tháng này còn dư bao nhiêu.</p>
          </article>
          <article className="landing__feature-card">
            <span className="landing__feature-icon" aria-hidden="true">
              ✓
            </span>
            <h3>Linh hoạt theo cách bạn sống</h3>
            <p>
              Ghi kèm tiền mặt, MoMo hay ngân hàng nếu cần đối chiếu; không bắt buộc phải quản lý
              tài khoản phức tạp.
            </p>
          </article>
        </div>
      ...
      <section className="landing__audience" id="danh-cho-ban" aria-labelledby="audience-title">
        <div className="landing__section-heading">
          <p className="landing__eyebrow">Một công cụ nhỏ, nhiều hoàn cảnh sống</p>
          <h2 id="audience-title">Minh Finance đồng hành cùng bạn theo cách riêng.</h2>
        </div>
        <div className="landing__audience-grid">
          <article>
            <span aria-hidden="true">01</span>
            <h3>Học sinh &amp; sinh viên</h3>
            <p>Theo dõi tiền ăn, tiền trọ, học phí và những khoản chi nhỏ hằng ngày.</p>
          </article>
          <article>
            <span aria-hidden="true">02</span>
            <h3>Mẹ bỉm &amp; gia đình trẻ</h3>
            <p>Nhìn rõ tiền chợ, đồ cho bé và các khoản chi chung để dễ cân đối hơn.</p>
          </article>
          <article>
            <span aria-hidden="true">03</span>
            <h3>Người làm tự do</h3>
            <p>Ghi lại thu nhập từng việc, tiền tip, chi phí đi lại và các khoản cần trả.</p>
          </article>
        </div>
      </section>
      ...
      <section className="landing__steps" aria-labelledby="steps-title">
        <div className="landing__section-heading">
          <p className="landing__eyebrow">Bắt đầu chỉ với 3 bước</p>
          <h2 id="steps-title">Bình tĩnh hơn với tiền của mình, từ hôm nay.</h2>
        </div>
        <ol>
          <li>
            <span>1</span>
            <div>
              <h3>Tạo tài khoản</h3>
              <p>Chỉ cần vài thông tin cơ bản để có cuốn sổ thu chi riêng.</p>
            </div>
          </li>
          <li>
            <span>2</span>
            <div>
              <h3>Ghi khoản đầu tiên</h3>
              <p>Ví dụ: “Chạy Bee 200.000 đ” hoặc “Nước mía 10.000 đ”.</p>
            </div>
          </li>
          <li>
            <span>3</span>
            <div>
              <h3>Xem lại và chủ động</h3>
              <p>Từng khoản nhỏ sẽ cho bạn một bức tranh lớn hơn về tài chính.</p>
            </div>
          </li>
        </ol>
      </section>
      ...
      <section className="landing__faq" id="cau-hoi" aria-labelledby="faq-title">
        <div className="landing__section-heading">
          <p className="landing__eyebrow">Câu hỏi thường gặp</p>
      ...
      <section className="landing__cta" aria-labelledby="cta-title">
        <p className="landing__eyebrow">Bắt đầu khi bạn sẵn sàng</p>
        <h2 id="cta-title">Mỗi khoản ghi lại là một bước gần hơn tới sự chủ động.</h2>
        <p>Không cần hoàn hảo. Chỉ cần bắt đầu bằng khoản thu hoặc chi đầu tiên.</p>
      ...
      <footer className="landing__footer">
        ...
        <p>Ghi thu chi đơn giản, để sống chủ động hơn mỗi ngày.</p>
        <div>
...
const landingStyles = `
  ...
  @media (max-width: 800px) {
    ...
    .landing__feature-grid, .landing__audience-grid { grid-template-columns: 1fr; }
    .landing__feature-card { min-height: auto; } .landing__feature-icon { margin-bottom: 18px; }
    .landing__steps { grid-template-columns: 1fr; gap: 28px; } .landing__footer { grid-template-columns: 1fr; }
  ...
  @media (max-width: 440px) {
    .landing__header, .landing__hero, .landing__section, .landing__audience, .landing__steps, .landing__faq, .landing__footer { width: min(100% - 28px, 1120px); }
